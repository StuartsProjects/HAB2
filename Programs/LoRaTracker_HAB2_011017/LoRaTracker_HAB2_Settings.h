...
******************************************************************************************************
  ...
  Copyright of the author Stuart Robinson - 1/10/2017
...
//#define Remove_GPS_Power                         //Some tracker boards can remove the power from the GPS, if so define this
#define Use_GPS_SoftwareBackup                   //some GPSs do not support this mode, Ubloxes do
...
//    This section determines which options are on or off by default, this is the default_config byte
//    Take care here..........
//**************************************************************************************************
