...
Copyright of the author Stuart Robinson - 15/06/2017
...
#define LoRaTracker_HAB1                         //specify board type here
...
const int  GPSShutdownTimemS = 1900;             //Software backup mode takes around 1.9secs to power down, used in maHr calculation
...
#define Sleepsecs 5             //sleep time in seconds after each TX loop gives approx 1 minute cycle
...
//**************************************************************************************************
// 11) GPS Test location settings - Cardiff Castle keep, used for testing purposes
//**************************************************************************************************
